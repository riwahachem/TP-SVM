...
Dans ce TP, nous mettons en pratique les SVM à l’aide du package scikit-learn. Les expériences portent à la fois sur des données simulées et sur des jeux de données réels, notamment le jeu de données Iris et une base d’images faciales.

L’objectif est de mieux comprendre le rôle des différents paramètres et choix de modélisation dans la performance d’un SVM, ainsi que les limites et solutions possibles en pratique.
